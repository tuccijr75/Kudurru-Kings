> Migrated note: Retained roster assignment doctrine migrated from migrate.zip. Use as a backfill/reference source, not stronger than Shipping Rules v1 + Gameplay Schema v1.
